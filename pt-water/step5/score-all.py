...
dt_ref = 2.5
dir_AIMD = '../step1/'
fn_trj_ref = dir_AIMD + 'ptwater-pos.xyz'
fn_trj_ref_au = dir_AIMD + 'ptwater-pos-bohr.xyz'
fn_frc_ref = dir_AIMD + 'ptwater-frc-harbohr.xyz'
#fn_vel_ref = dir_AIMD + 'bulk_water_AIMD-vel-1.xyz'
fn_topo_ref = dir_AIMD + 'top.pdb'
fn_topo_ref_au = dir_AIMD + 'top_au.pdb'
...
dt_test = 2.5
dir_C_NNP = '../step42/'
fn_trj_test = dir_C_NNP + 'ptwat-04-pos-1.xyz'
#fn_vel_test = dir_C_NNP + 'ptwat-04-vel-1.xyz'
...
frames = aml.read_frames_cp2k(fn_positions=fn_trj_ref_au, fn_forces=fn_frc_ref, cell=np.array([[27.5301731592, 0, 0], [0, 37.0872900633, 0], [0, 0, 67.9203548822]]))
structures_ref = aml.Structures.from_frames(frames, stride=1, probability=1.0)

# perform force RMSE scoring
mlps.run_rmse_test(dir_model, fn_topo_ref_au, structures_ref)
